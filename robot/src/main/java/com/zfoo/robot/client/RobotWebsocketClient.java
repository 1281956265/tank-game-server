 ...
 * @author godotg
 */
public class RobotWebsocketClient extends AbstractClient<SocketChannel> {

    private final WebSocketClientProtocolConfig webSocketClientProtocolConfig;

    public RobotWebsocketClient(HostAndPort host, WebSocketClientProtocolConfig webSocketClientProtocolConfig) {
        super(host);
    ...
    public void initChannel(SocketChannel channel) {
        ...
        channel.pipeline().addLast(new RobotClientRouteHandler());
    }
}
